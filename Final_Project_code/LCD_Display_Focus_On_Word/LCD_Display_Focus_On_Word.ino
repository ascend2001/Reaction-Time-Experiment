...
const int rs=12, en=11, d4=5, d5=4, d6=3, d7=2, redButtonPin=8, greenButtonPin=9, blueButtonPin=10, pin[5]={13,6,7, A1, A2};
LiquidCrystal lcd(rs, en, d4, d5, d6, d7);
int randNumber, randDelay,redButtonState=LOW, greenButtonState=LOW, blueButtonState=LOW, yellowButtonState=LOW, whiteButtonState=LOW, state=0, randN, randPin;
